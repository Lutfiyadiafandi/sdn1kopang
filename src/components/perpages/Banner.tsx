...
const Banner = () => {
  ...
  // ];
  return (
    <section className="relative w-full h-screen md:h-max">
      <div className="relative w-full overflow-hidden">
        <img
          src={images}
          alt=""
          className="w-full h-screen object-cover object-center md:h-max"
        />
        <div className="absolute bottom-5 inset-0 bg-black opacity-30"></div>
      </div>
      <div className="w-full px-2 absolute top-1/2 xl:top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 xl:-translate-y-1/3">
        <h1 className="text-heading4 lg:text-heading2 font-bold text-basic-50 text-center">
          Selamat Datang di <br /> Situs Web SD Negeri 1 Kopang
        </h1>
        <p className="mt-5 text-type-l font-semibold text-basic-50 text-center">
